...
def report_to_str(truss: Truss, goals: Goals, with_figures: bool = True) -> str:
    ...
    Finally, let's generate a report on the truss
    >>> report = trussme.report_to_str(small_truss, trussme.Goals(), with_figures=False)
    >>> print(report)
    # SUMMARY OF ANALYSIS
    - The truss has a mass of 22.48 kg, and a total factor of safety of 0.96.
    - The limit state is buckling.
    - The design goals for yielding FOS, mass, and deflection were satisfied.
    - The design goal for buckling FOS was not satisfied.
    <BLANKLINE>
    |                          |   Target |      Actual | Ok?   |
    |:-------------------------|---------:|------------:|:------|
    | Minimum FOS for Buckling |        1 |  0.958918   | No    |
    | Minimum FOS for Yielding |        1 |  8.38732    | Yes   |
    | Maximum Mass             |      inf | 22.4804     | Yes   |
    | Maximum Deflection       |      inf |  0.00104247 | Yes   |
    # INSTANTIATION INFORMATION
    ## JOINTS
    |          |   X |   Y |   Z | X Support?   | Y Support?   | Z Support?   |
    |:---------|----:|----:|----:|:-------------|:-------------|:-------------|
    | Joint_00 | 0   | 0   |   0 | True         | True         | True         |
    | Joint_01 | 2.5 | 2.5 |   0 | False        | False        | True         |
    | Joint_02 | 5   | 0   |   0 | False        | True         | True         |
    ## MEMBERS
    |           |   Beginning Joint |   Ending Joint | Material   | Shape   | Parameters (m)   |   Mass (kg) |
    |:----------|------------------:|---------------:|:-----------|:--------|:-----------------|------------:|
    | Member_00 |                 0 |              1 | A36_Steel  | pipe    | r=0.02, t=0.002  |     6.58435 |
    | Member_01 |                 0 |              2 | A36_Steel  | pipe    | r=0.02, t=0.002  |     9.31168 |
    | Member_02 |                 2 |              1 | A36_Steel  | pipe    | r=0.02, t=0.002  |     6.58435 |
    ## MATERIALS
    |           |   Density (kg/m3) |   Elastic Modulus (GPa) |   Yield Strength (MPa) |
    |:----------|------------------:|------------------------:|-----------------------:|
    | A36_Steel |              7800 |                     200 |                    250 |
    ...
    |:---------|:------------------|:------------------|------------------:|
    | Joint_00 | 0.00              | 5.03              |                 0 |
    | Joint_01 | N/A               | N/A               |                 0 |
    | Joint_02 | N/A               | 5.03              |                 0 |
    ## FORCES AND STRESSES
    |           |   Area (m^2) |   Moment of Inertia (m^4) |   Axial force(kN) |   FOS yielding | OK yielding?   | FOS buckling      | OK buckling?   |
    |:----------|-------------:|--------------------------:|------------------:|---------------:|:---------------|:------------------|:---------------|
    | Member_00 |  0.000238761 |                  4.32e-08 |             -7.12 |        8.38732 | Yes            | 0.958918112668615 | No             |
    | Member_01 |  0.000238761 |                  4.32e-08 |              5.03 |       11.8615  | Yes            | N/A               | Yes            |
    | Member_02 |  0.000238761 |                  4.32e-08 |             -7.12 |        8.38732 | Yes            | 0.958918112668615 | No             |
    ## DEFLECTIONS
    |          | X Deflection(mm)   | Y Deflection (mm)   | Z Deflection (mm)   | OK Deflection?   |
    |:---------|:-------------------|:--------------------|:--------------------|:-----------------|
    | Joint_00 | N/A                | N/A                 | N/A                 | Yes              |
    | Joint_01 | 0.26346            | -1.00863            | N/A                 | Yes              |
    | Joint_02 | 0.52692            | N/A                 | N/A                 | Yes              |
    <BLANKLINE>
    """
    truss.analyze()
